(module
 ...
 (data (i32.const 1800) "\01\00\00\00\0c\00\00\00o\00b\00j\00e\00c\00t")
 (data (i32.const 1820) ",")
 (data (i32.const 1832) "\01\00\00\00\12\00\00\00u\00n\00d\00e\00f\00i\00n\00e\00d")
 (data (i32.const 1868) "<")
 ...
 (data (i32.const 2000) "\16\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 2028) "A\08\00\00\02\00\00\00A\00\00\00\02\00\00\00\81\08\00\00\02\00\00\00\81\00\00\00\02\00\00\00\01\t\00\00\02\00\00\00\01\01\00\00\02\00\00\00\01\19\00\00\02\00\00\00\01\1a\00\00\02\00\00\00\01\n\00\00\02\00\00\00\01\02\00\00\02\00\00\00\02\t\00\00\00\00\00\00\02\n\00\00\00\00\00\00\02A\00\00\00\00\00\00B\00\00\00\00\00\00\00\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00\02A\00\00\00\00\00\00\02A")
 ...
 (global $assembly/index/BLOCK_SIZE (mut i32) (i32.const 0))
 ...
 (global $assembly/index/globalHashTables (mut i32) (i32.const 0))
 ...
 (export "compress" (func $export:assembly/index/compress))
 (start $~start)
 ...
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $assembly/index/globalHashTables
  local.tee $0
  if
   local.get $0
 ...
 (func $~lib/array/Array<~lib/typedarray/Uint16Array>#set:buffer (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
  local.get $0
 ...
 (func $assembly/index/load32 (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
 ...
 (func $assembly/index/equals32 (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  local.get $1
  call $~lib/typedarray/Uint8Array#__get
  local.get $0
 ...
 (func $assembly/index/emitLiteral (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  local.get $2
  i32.const 60
 ...
 (func $assembly/index/emitCopyLessThan64 (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  local.get $2
  i32.const 2048
  i32.lt_s
  i32.const 0
 ...
 (func $~start
  ...
  (local $1 i32)
  i32.const 65536
  global.set $assembly/index/BLOCK_SIZE
  memory.size
  i32.const 16
  i32.shl
  i32.const 18564
  ...
  local.get $0
  i32.const 0
  call $~lib/array/Array<~lib/typedarray/Uint16Array>#set:buffer
  local.get $0
  i32.const 0
  i32.store offset=4
  local.get $0
  ...
  global.set $~lib/memory/__stack_pointer
  local.get $0
  global.set $assembly/index/globalHashTables
 )
 (func $~stack_check
  global.get $~lib/memory/__stack_pointer
  i32.const 2180
 ...
 (func $assembly/index/compressFragment (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
   ...
   loop $while-continue|2
    ...
    if
     block $while-break|2
      ...
      local.get $3
      local.get $4
      call $assembly/index/emitLiteral
      local.set $4
      loop $do-continue|4
       block $do-break|4
        local.get $1
        ...
        loop $while-continue|01
         ...
         if
          ...
          local.get $8
          i32.const 64
          call $assembly/index/emitCopyLessThan64
          local.set $4
          local.get $5
          i32.const -64
          i32.add
 ...
 (func $assembly/index/compress (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  loop $while-continue|0
   ...
   if
    ...
    i32.sub
    f64.convert_i32_s
    global.get $assembly/index/BLOCK_SIZE
    f64.convert_i32_s
    f64.min
    i32.trunc_f64_s
    local.tee $4
    local.get $2
    local.get $0
    call $assembly/index/compressFragment
    local.set $0
    local.get $3
    local.get $4
    i32.add
 ...
 (func $export:assembly/index/compress (param $0 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
